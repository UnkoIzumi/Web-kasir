/*==============================================================*/
/* DBMS name:      MySQL 5.0                                    */
/* Created on:     12/18/2021 8:09:08 PM                        */
/*==============================================================*/
...
STATUS VARCHAR(5) comment '',
   TANGGAL_ABSENSI      date comment '',
   JAM_ABSENSI          time comment '',
...
(
   ID_BARANG            int not null  comment '',
   ID_NOTA              varchar(50) not null  comment '',
   ID_DETIL             int not null  auto_increment comment '',
   JUMLAH_BARANG        int not null  comment '',
   TOTAL_HARGA          int not null  comment '',
   primary key (ID_BARANG, ID_NOTA, ID_DETIL)
);
...
create table NOTA
(
   ID_NOTA              varchar(100) not null  comment '',
   TOTAL_PENJUALAN      int   comment '',
   JAM_PENJUALAN        time    comment '',
   TANGGAL_PENJUALAN    date   comment '',
   primary key (ID_NOTA)
);
...
(
   ID_PEMBELIAN         int not null auto_increment  comment '',
   ID_BARANG            int not null  comment '',
   JUMLAH_PEMBELIAN     int not null  comment '',
   TOTAL_BAYAR          int not null  comment '',
   TANGGAL_PEMBELIAN    date not null  comment '',
